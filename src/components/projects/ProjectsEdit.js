    ...
    <Edit {...props} actions={<EditActions title={<ProjectTitle />} />}>
      <TabbedForm redirect={props.location.pathname}>
          ...
          >
            <Datagrid expand={<BorrowerEditPanel redirectId={props.id} />}>
              ...
              <FunctionField
                ...
                render={record =>
                  record.borrowerCompanyOwnership.length != 0
                    ? record.borrowerCompanyOwnership.forEach(
                        (bc, index) =>
                          (`${bc.contact.firstName}` +
                            ` ` +
                            `${bc.contact.lastName} + `) |
                          `${bc.ownershipPercentage}%`
                      )
                    : ''
                }
              />
        ...
        <FormTab label="Debt Service Ratio" path={'edit_debt_service_ratios'}>
          <ReferenceManyField
            label="Project Debt Service Ratios"
            reference="debt_service_ratios"
            target="project"
          >
            <Datagrid>
              ...
              <FieldGuesser
                label="Last Updated"
                source="debtServiceRatioUpdatedOn"
              />
              <ModalEditButton
            ...
            <Grid container direction="row" alignItems="center" spacing={6}>
              ...
              <Grid item className={classes.gridItem} xs={12} sm={6} lg={4}>
                <TextInput
                  multiline
                  fullWidth
                  label="Sale Increases"
                  source="saleIncreases"
                />
              </Grid>
              <Grid item className={classes.gridItem} xs={12} sm={6} lg={4}>
                <NullableBooleanInput
                  style={{ width: '100%' }}
                  label="SBA Appraisal Approval"
                  source="sbaAppraisalApproval"
                />
              </Grid>
              <Grid item className={classes.gridItem} xs={12} sm={6} lg={4}>
                <TextInput
